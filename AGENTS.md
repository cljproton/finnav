...
Backend (Django + DRF) and frontend (Next.js/React) for "FinNav" — a finance-site navigation tool.
...
- **Frontend-only changes: skip backend tests; run `cd frontend && npm run build` instead.**
